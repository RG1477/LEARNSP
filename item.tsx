...
import * as ItemPrimitive from 'cmdk'
...
const Item = React.forwardRef<
  React.ElementRef<typeof ItemPrimitive.Item>,
  React.ComponentPropsWithoutRef<typeof ItemPrimitive.Item> & {
    inset?: boolean
    isSelected?: boolean
  }
...
Item.displayName = ItemPrimitive.Item.displayName
...
const itemMediaVariants = cva(
  'flex shrink-0 items-center justify-center gap-2 group-has-[[data-slot=item-description]]/item:self-start [&_svg]:pointer-events-none group-has-[[data-slot=item-description]]/item:translate-y-0.5',
  {
    variants: {
      variant: {
        default: 'bg-transparent',
        icon: "size-8 border border-slate-700 rounded-sm bg-muted [&_svg:not([class*='size-'])]:size-4",
        image:
